...
public class Solution {
    ...
    public static class MarkTwainBook extends Book
    {
        ...
        public MarkTwainBook(String bookName){super("Mark Twain");
        this.bookName = bookName;} //constructor variable bookName - the name of book
    ...
    public static class AgathaChristieBook extends Book
    {
        public String bookName;
        public String getName(){return bookName;}
        public AgathaChristieBook(String bookName){super("Agatha Christie");
