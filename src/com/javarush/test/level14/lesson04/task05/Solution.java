...
public class Solution
{
    ...
    {
        //Add your code here
        if (person instanceof Player){((Player)person).play();}  //расширение класса т.к. person не содержит
        if (person instanceof Dancer) {((Dancer) person).dance();} //методов play & dance поєтому используем приведение типов
    }
